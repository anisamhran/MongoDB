...
// KategoriModul adalah struktur untuk data kategori modul
type KategoriModul struct {
    ID          primitive.ObjectID `bson:"_id,omitempty" json:"id,omitempty"`       // ID unik kategori modul
    Name        string             `bson:"name" json:"name"`                       // Nama kategori modul
